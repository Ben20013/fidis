...
<template lang="html">
  <div class="main-box flex-column" :style="mainBoxStyle">
          ...
          <div class="header-content flex-column">
            <div class="header__top-content flex-wrap">
              ...
              <div class="header__top-content_right flex-wrap">
                ...
                <div class="header__top-content_user flex-wrap" :class="{'active':isShowMenu}" @mouseover="isShowMenu=true" @mouseleave="isShowMenu=false">
    ...
    <div class="user-menu" v-show="isShowMenu" @mouseover="isShowMenu=true" @mouseleave="isShowMenu=false" :style="userMenuStyle">
...
export default {
  ...
  computed: {
    userMenuStyle() {
      let $user = this.userMenuDom
      if (!$user) {
        return {}
      }
      let height = $user.offsetHeight
      let top = $user.offsetTop + height
      let left = $user.offsetLeft
