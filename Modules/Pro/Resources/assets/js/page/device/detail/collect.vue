...
<template>
    ...
    <div class="collect-content-wrap flex-column">
        ...
        <div class="collect-btn" @click="openCollectWin">{{$t('deviceLang.data_collect')}}</div>
            </div>-->
            <div class="collect-list flex-column">
                <div class="list-header">
                    <table>
                        ...
                        <thead>
                            <tr>
                                <th>{{$t('deviceLang.collect_time')}}</th>
                                <th>{{$t('deviceLang.collect_staff')}}</th>
                                <th>{{$t('deviceLang.collect_type')}}</th>
                                <th>{{$t('deviceLang.collect_value')}}</th>
            ...
            <div class="md-modal md-effect-1 view-collect" :class="{ 'md-show': md.viewCollect}">
                <div class="md-content">
                    ...
                    <div class="titleBox flex-wrap flex-center">
                        <div class="title">{{$t('deviceLang.view_collect_title')}}</div>
                    ...
                    <div class="contBox">
                        <div class="view-info-wrap" v-if="collectInfoData!=null">
                            <div class="row-wrap flex-wrap">
                                <!-- <div class="col-wrap">
                  <div class="title">{{$t('deviceLang.data_name')}}</div>
        ...
        <div class="md-modal-container">
            <div class="md-modal md-effect-1 collect-data" :class="{ 'md-show': md.collect}">
                <div class="md-content">
                    <!--头部-->
                    <div class="titleBox flex-wrap flex-center">
                        <div class="title">{{$t('deviceLang.data_collect')}}</div>
                    ...
                    <div class="contBox">
                        <div class="collect-item-table">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <div class="desc-title">{{$t('deviceLang.data_type')}}</div>
                                        <div class="block">
                                            <el-select
                                    ...
                                    <td>
                                        <div class="desc-title">{{$t('deviceLang.unit')}}</div>
                                        <div class="block">
                                            <el-input
                                ...
                                <tr>
                                    <td>
                                        <div class="desc-title">{{$t('deviceLang.collect_value')}}</div>
                                        <div class="block">
                                            <el-input
                                    ...
                                    <td>
                                        <div class="desc-title">{{$t('deviceLang.collect_time')}}</div>
                                        <div class="block">
                                            <el-date-picker
                                                v-model="collectTimeValue"
                                                type="datetime"
                                                value-format="yyyy-MM-dd HH:mm:ss"
                                                :placeholder="$t('common.placeholder_date')"
                                            ></el-date-picker>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="desc-title">{{$t('deviceLang.collect_staff')}}</div>
                                        <div class="block">
                                            <el-input
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div
                                            class="desc-title"
                                        >{{$t('deviceLang.collect_description')}}</div>
                                        <el-input
                                            type="textarea"
                                            :rows="3"
                                            :placeholder="$t('common.placeholder_input')"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="desc-title">{{$t('deviceLang.annex')}}</div>
...
export default {
    ...
    methods: {
        ...
        openCollectWin() {
            ...
            if (!this.equipmentId) {
                this.$alert(
                    this.$t("deviceLang.no_equipment_collect_tip"),
                    this.$t("deviceLang.data_collect"),
                    {
        ...
        addCollectData() {
            // if (this.collectNameValue == '') {
            //   this.$alert(this.$t('deviceLang.summary_not_null'),this.$t('deviceLang.data_collect'),{
            //     confirmButtonText:this.$t('el.messagebox.confirm'),
            //   })
            //   return false;
            // }
            if (this.collectDataValue == "") {
                this.$alert(
                    this.$t("deviceLang.collect_value_not_null"),
                    this.$t("deviceLang.data_collect"),
                    {
                        confirmButtonText: this.$t("el.messagebox.confirm")
                    }
            ...
            collectApi.add_collect_data(
                data => {
                    if (data.code == 200) {
                        self.getCollectList(self.equipmentId);
...
@import "../../../../sass/device/detail/collect.scss";
</style>
