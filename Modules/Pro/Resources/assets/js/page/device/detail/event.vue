    ...
    <div class="equipment-efa-content-wrap flex-column">
                    ...
                    <table>
                        ...
                        <tbody v-if="eventData!=null">
                            <tr v-for="(item,index) in eventData" :key="index">
                                ...
                                <td>
                                    <a
                                        @click="getEventMosaicDetailInfo(item.event_id)"
                                    >{{$t('deviceLang.view')}}</a>
                                </td>
                            </tr>
                        </tbody>
        ...
        <div class="md-modal-container">
            <div
                ...
                :class="{ 'md-show': md.viewEvent}"
            >
                <div class="md-content">
                    <!--头部-->
                    <div class="titleBox flex-wrap flex-center">
                        <div class="title">{{$t('deviceLang.view_event_title')}}</div>
                    ...
                    <div class="contBox">
                        <div class="view-info-wrap" v-if="eventInfoData!=null">
                            ...
                            <div class="row-wrap flex-wrap">
                                ...
                                <div class="col-wrap">
                                    <div class="title">{{$t('deviceLang.code')}}</div>
                                    <div class="value">{{eventInfoData.code}}</div>
                                </div>
                            </div>
                            <div class="row-wrap flex-wrap">
                                <div class="colAll">
                                    <div class="title">{{$t('deviceLang.event_description')}}</div>
...
@import "../../../../sass/device/detail/efa.scss";
</style>
