...
export default {
  ...
  data(){
    return {
      ...
      searchOption: [
        ...
        { label: this.$t("eventLang.fault_name"), value: "fault_name" }
      ],
  ...
  methods: {
    ...
    enterDetailPage(item, index) {
        ...
        this.$emit("nav-title", { name: item.name, id: item.fault_id, type: 'fault' });
        this.$router.push({
            name: "eventDetail",
            path: "/event/detail",
            query: {
