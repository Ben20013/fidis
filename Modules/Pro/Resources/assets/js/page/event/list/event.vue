        ...
        <table>
          ...
          <thead>
            <tr>
                ...
                <th>{{$t('eventLang.event_name')}}</th>
              <!-- <th>{{$t('eventLang.event_id')}}</th> -->
...
export default {
  ...
  data(){
    return {
      ...
      searchOption: [
        ...
        { label: this.$t("eventLang.event_name"), value: "event_name" }
      ],
  ...
  methods: {
    ...
    enterDetailPage(item, index) {
        ...
        this.$emit("nav-title", { name: item.event_name, id: item.event_id, type: 'event' });
        this.$router.push({
            name: "eventDetail",
            path: "/event/detail",
            query: {
